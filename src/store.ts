...
export class ReplStore implements Store {
  ...
  constructor({
    serializedState = '',
    defaultVueRuntimeURL = `https://cdn.jsdelivr.net/npm/vue@2.7.10/dist/vue.esm.browser.js`,
    showOutput = false,
    outputMode = 'preview'
  }: StoreOptions = {}) {
  ...
  async setVueVersion(version: string) {
    ...
    const runtimeUrl = `https://cdn.jsdelivr.net/npm/vue@${version}/dist/vue.esm.browser.js`
